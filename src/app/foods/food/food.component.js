...
var FoodComponent = (function () {
    ...
    FoodComponent.prototype.delete = function () {
        var _this = this;
        var msg = "Do you want to delete the " + this.food.name + "?";
        this.modalService.activate(msg).then(function (responseOK) {
            if (responseOK) {
                _this.cancel(false);
                _this.foodService.deleteFood(_this.food)
                    .subscribe(function () {
                    _this.toastService.activate("Deleted " + _this.food.name);
                    _this.gotoFoods();
    ...
    FoodComponent.prototype.save = function () {
        ...
        this.foodService.updateFood(this.food)
            .subscribe(function () { return _this.toastService.activate("Successfully saved " + _this.food.name); });
    };
