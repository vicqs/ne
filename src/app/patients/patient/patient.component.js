...
var PatientComponent = (function () {
    ...
    PatientComponent.prototype.save = function () {
        ...
        this.patientService.updatepatient(patient)
            .subscribe(function () { return _this.toastService.activate("Successfully saved " + patient.name); });
    };
